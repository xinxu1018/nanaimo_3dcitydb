...
def import_InterFeatureLinks(citygml, cur):
    ...
    for interfeaturelink in citygml.findall(".//utility:InterFeatureLink", ns):
        ...
        for interfeaturelink_child in list(interfeaturelink):
            ...
            if interfeaturelink_child.tag == "{http://www.citygml.org/ade/utility/0.9.2}start":
                ...
                interfeaturelink_type =  interfeaturelink_child.attrib['{http://www.citygml.org/ade/utility/0.9.2}type']
                interfeaturelink_sql_dict['type'] = interfeaturelink_type
